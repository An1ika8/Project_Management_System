  ...
  return (
    <div className="Home">
      ...
      >
        {showPDFOptions
          ? "Hide PDF Options"
          : "Generate PDF Report to Display Current Project Details"}
      </button>
              ...
              data.map((project) => (
                <tr key={project.project_id}>
                  ...
                  <td className="action-buttons">
                    ...
                    <Link to={`/edit/${project.project_id}`} className="icon">
                      <img src="https://cdn-icons-png.flaticon.com/128/1827/1827933.png" alt="edit icon" />
                    </Link>


                    <Link to={`/show/${project.project_id}`} className="icon">
                      <img src="https://cdn-icons-png.flaticon.com/128/6592/6592963.png" alt="show icon" />
                    </Link>

                    <Link >
                      <span onClick={() => handleDelete(project.project_id)} className="icon">
                        <img src="https://cdn-icons-png.flaticon.com/128/11540/11540197.png" alt="show icon" />
                      </span>
                    </Link>
                  ...
                  <td>
                    <ul>
                      {projectMembers[project.project_id] &&
                        projectMembers[project.project_id].length > 0 ? (
